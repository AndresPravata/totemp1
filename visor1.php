...
<head>
    ...
    <style>
        ...
        #veterinaria-container .box2 {
            display: flex; /* Mostrar los elementos internos en línea */
            align-items: center; /* Centrar los elementos internos horizontalmente */
            margin-top: 10px; /* Espacio entre Box 1 y Box 2 */
        }
    </style>
</head>
<body>
  ...
  <div id="turnos-container">
        ...
        <div id="comercial-container">
            ...
            <p><?php echo $turnos_actuales['comercial']; ?></p>
        </div>
        
        <!-- Sección de Veterinaria -->
        <div id="veterinaria-container">
            <h2><strong>Veterinaria</strong></h2>
            <!-- Mostrar el turno actual en Box 1 -->
            <p><strong>Box 1</strong> <?php echo $turnos_actuales['veterinaria'][1]; ?></p>
            <!-- Mostrar el turno actual en Box 2 -->
            <div class="box2">
                <strong>Box 2</strong> <?php echo $turnos_actuales['veterinaria'][2]; ?>
            </div>
        </div>
    </div>
