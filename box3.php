...
// Función para marcar el turno del Box 3 como finalizado
function marcarTurnoFinalizado() {
    global $conn;
    
    // Obtener el turno actual del Box 3
    $sql = "SELECT nombre_turno FROM turnos WHERE numero_box = 3 AND estado = 'actual' LIMIT 1";
...
<header id="header">
    ...
    <script>
        ...
        function updateVisor() {
            ...
            document.getElementById("box3-current-turn").innerText = "";

            // Mostrar el turno actual del box 2
            if (box1CurrentTurn) {
                document.getElementById("box3-current-turn").innerText = box3CurrentTurn.nombre_turno;
            }
        }
        ...
        function updateTurns() {
            ...
            xmlhttp.onreadystatechange = function() {
                if (this.readyState == 4 && this.status == 200) {
                    ...
                    box3CurrentTurn = response.box3CurrentTurn;
                    updateVisor();
                }
            };
